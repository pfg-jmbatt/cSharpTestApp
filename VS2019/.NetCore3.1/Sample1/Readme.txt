...
From the Windows command prompt, change to this directory (VS2019\.NetCore3.1\Sample1), and then run the following commands:
...
2. Change to this directory (VS2019\.NetCore3.1\Sample1) and run the following commands:
  $ sourceanalyzer -b cs-sample -clean
